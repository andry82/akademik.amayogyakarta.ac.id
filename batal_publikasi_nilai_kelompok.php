...
while ($data = mysqli_fetch_array($data_kk)) {
    $nim = $data['NIMHSTRNLM'];
    mysqli_query($mysqli, "UPDATE  trnlm SET NLAKHTRNLM='', BOBOTTRNLM='' WHERE NIMHSTRNLM='$nim' AND KDKMKTRNLM='$kodemk'");
}
mysqli_query($mysqli, "UPDATE dosen_kelompok SET PUBNILAI='0' WHERE id='$id_kelompok'");
