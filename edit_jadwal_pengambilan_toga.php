...
<html lang="en">
    ...
    <head>
        ...
        <title>EDIT JADWAL PENGAMBILAN TOGA | SISTEM INFORMASI AKADEMIK - AMA Yogyakarta</title>
    ...
    <body onload="tampilkanwaktu(); setInterval('tampilkanwaktu()', 1000);">	
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header"><i class="fa fa-edit fa-fw"></i> EDIT JADWAL PENGAMBILAN</h4>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <?php
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php
                        $id = $_GET['id'];
                        $res = mysqli_query($mysqli, "SELECT * FROM jadwal_pengambilan_toga WHERE id=$id");
                        $data = mysqli_fetch_array($res)
                        ?>
                        <form name="form" method="post" action="update_jadwal_pengambilan_toga.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ruang" value="<?php echo $data['ruang']; ?>" placeholder="Tempat">
                            </div>                           
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <a href="jadwal_pengambilan_toga.php" class='btn btn-primary btn-sm'><i class="fa fa-backward fa-fw"></i> KEMBALI</a>   
