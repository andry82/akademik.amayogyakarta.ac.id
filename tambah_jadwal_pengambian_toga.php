...
<html lang="en">
    ...
    <head>
        ...
        <title>TAMBAH JADWAL PENGAMBILAN TOGA | SISTEM INFORMASI AKADEMIK - AMA Yogyakarta</title>
    ...
    <body onload="tampilkanwaktu(); setInterval('tampilkanwaktu()', 1000);">	
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header"><i class="fa fa-plus fa-fw"></i> TAMBAH JADWAL PENGAMBILAN</h4>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <?php
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form name="form" method="post" action="proses_tambah_jadwal_pengambilan_toga.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ruang" placeholder="Tempat">
                            </div>                           
                            <div class="form-group">
