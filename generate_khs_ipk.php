...
$NIM=$_GET['nim'];
$ta=$_GET['ta'];
$kls = "SELECT nmkelas from kelasparalel_mhs where nimhs='$NIM'";
	...
	<tr class="ewTableAltRow">
                                              ...
                                              <td class="ewRptDtlField" align="center" valign="center" rowspan=2>NIM</td>
											   <td class="ewRptDtlField" align="center" valign="center" rowspan=2>Nama</td>
												...
												if($IPSEMYA=="ya")
												{
$qmapel = "SELECT distinct(THSMSTRAKM) from trakm order by THSMSTRAKM ASC";
...
<?
$qall = "SELECT * FROM msmhs m where m.TAHUNMSMHS='$TAHUN' and m.KDPSTMSMHS='$JUR' and m.NIMHSMSMHS='$NIM' order by m.NIMHSMSMHS ASC";		
...
$qmapel2 = "SELECT distinct(THSMSTRAKM) from trakm order by THSMSTRAKM ASC";
											  ...
											  $nasksipk=0;
											   ...
											   while($datamapel2 = mysql_fetch_array($hasilmapel2))
												...
												$cekaktif = "SELECT NLIPSTRAKM,SKSEMTRAKM,NLIPKTRAKM,SKSTTTRAKM from trakm where THSMSTRAKM='$THSMSTRAKM2' and NIMHSTRAKM='$nim' order by THSMSTRAKM ASC";
	...
	$tr2++;
											  $totip = "SELECT distinct(KDKMKTRNLM),NIMHSTRNLM,NLAKHTRNLM,BOBOTTRNLM from trnlm  where THSMSTRNLM='$THSMSTRAKM2' and NIMHSTRNLM='$nim' order by KDKMKTRNLM ASC,BOBOTTRNLM DESC";
											   ...
											   $ipsem=0;
											    while($dataip = mysql_fetch_array($hasilip))
												{
													...
													$bobot= $dataip["BOBOTTRNLM"];
													 ...
													 $totmk= "SELECT m.SKSMKTBKMK,m.kdkonsen from tbkmk m where m.KDKMKTBKMK='$kode' and m.THSMSTBKMK='$THSMSTRAKM2' and (m.kdkonsen='u' or m.kdkonsen='$kdkonsen') limit 0,1";
											...
											$nasks=$sks*$bobot;
												 ...
												 $totip2 = "SELECT distinct(KDKMKTRNLM) from trnlm  where ($name1q) and NIMHSTRNLM='$nim' order by KDKMKTRNLM,NLAKHTRNLM ASC";
											  ...
											  $ipk2=0;
												...
												//perubahan 29 oktt 2012
												 $totip3 = "SELECT NLAKHTRNLM,BOBOTTRNLM,THSMSTRNLM,KDKMKTRNLM from trnlm  where ($name1q) and NIMHSTRNLM='$nim' and KDKMKTRNLM='$kode2' order by NLAKHTRNLM ASC LIMIT 0,1";
											  //
											  ...
											  $dataip3 = mysql_fetch_array($hasilip3);
													...
													$kode3= $dataip3["KDKMKTRNLM"];
													 ...
													 $totmk2= "SELECT m.SKSMKTBKMK,m.kdkonsen from tbkmk m where m.KDKMKTBKMK='$kode3' and m.THSMSTBKMK='$THSMSTRNLM' and (m.kdkonsen='u' or m.kdkonsen='$kdkonsen') limit 0,1";
											...
											$nasks2=$sks2*$bobot2;
											 ...
											 $cekada = "SELECT * from trakm where NIMHSTRAKM='$nim' and THSMSTRAKM='$THSMSTRAKM2'";
											  $hasilada = mysql_query($cekada);
											   $adakah=mysql_numrows($hasilada);
											   if($adakah<=0)
											   {
											   $qall22 = "INSERT INTO trakm(THSMSTRAKM,KDPTITRAKM,KDJENTRAKM,KDPSTTRAKM,NIMHSTRAKM,SKSEMTRAKM,nodos,NLIPSTRAKM,NLIPKTRAKM,SKSTTTRAKM,bobottotal) VALUES('$THSMSTRAKM2','054043','E','61401','$nim','$sks_mapelx','$totsks','$ipsem','$ipk2','$totsksipk2','$totnasks')";
												$hasilall22 = mysql_query($qall22);
											   }else
											   {
											   
												$updatenilai = "UPDATE trakm SET NLIPSTRAKM=$ipsem,SKSEMTRAKM=$totsks,NLIPKTRAKM=$ipk2,SKSTTTRAKM=$totsksipk2,bobottotal=$totnasks where NIMHSTRAKM='$nim' and THSMSTRAKM='$THSMSTRAKM2'";
									...
									$name1q ="";
												...
												<?
												 ...
												 $totip2 = "SELECT distinct(KDKMKTRNLM) from trnlm  where NIMHSTRNLM='$nim' and (NLAKHTRNLM<>'')  order by KDKMKTRNLM,NLAKHTRNLM ASC";
											  ...
											  $ipk2=0;
												...
												$a2++;
												$kode2= $dataip2["KDKMKTRNLM"];
												 $totip3 = "SELECT NLAKHTRNLM,BOBOTTRNLM,THSMSTRNLM,KDKMKTRNLM from trnlm  where NIMHSTRNLM='$nim' and KDKMKTRNLM='$kode2' order by NLAKHTRNLM ASC LIMIT 0,1";
											  $hasilip3 = mysql_query($totip3);
											  $dataip3 = mysql_fetch_array($hasilip3);
													...
													$kode3= $dataip3["KDKMKTRNLM"];
													 ...
													 $totmk2= "SELECT m.SKSMKTBKMK from tbkmk m where m.KDKMKTBKMK='$kode3' and m.THSMSTBKMK='$THSMSTRNLM' and m.KDPSTTBKMK='$JUR' and (m.kdkonsen='u' or m.kdkonsen='$kdkonsen') ";
											  $hasilmk2 = mysql_query($totmk2);
											 $datamk2 = mysql_fetch_array($hasilmk2);
											  $sks2= $datamk2["SKSMKTBKMK"];
											$nasks2=$sks2*$bobot2;
...
?>
<?php echo '<script>window.location.href = "cetak_khs.php?ta='.$ta.'&nim='.$NIM.'";</script>'; ?>
</div>
</body>
</html>
