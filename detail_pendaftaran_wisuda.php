                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if ($status_pendaftaran == 0) { ?>
                            <a href="proses_status_laporan_ta.php?upload_id=<?php echo $id; ?>&tahun=<?php echo $ta; ?>&status=0" class='btn btn-success btn-xs'>PENGAJUAN</a>&nbsp;
                            <a data-toggle="modal" data-target="#exampleModalCenter" class='btn btn-default btn-xs'>REVISI</a>&nbsp;
                            <a href="proses_status_laporan_ta.php?upload_id=<?php echo $id; ?>&tahun=<?php echo $ta; ?>&status=2" class='btn btn-default btn-xs'>ACC</a><br/>
                        <?php } elseif ($status_pendaftaran == 1) { ?>
                            <a href="proses_status_laporan_ta.php?upload_id=<?php echo $id; ?>&tahun=<?php echo $ta; ?>&status=0" class='btn btn-default btn-xs'>PENGAJUAN</a>&nbsp;
                            <a data-toggle="modal" data-target="#exampleModalCenter" class='btn btn-warning btn-xs'>REVISI</a>&nbsp;
                            <a href="proses_status_laporan_ta.php?upload_id=<?php echo $id; ?>&tahun=<?php echo $ta; ?>&status=2" class='btn btn-default btn-xs'>ACC</a><br/>
                        <?php } elseif ($status_pendaftaran == 2) { ?>
                            <a href="proses_status_laporan_ta.php?upload_id=<?php echo $id; ?>&tahun=<?php echo $ta; ?>&status=0" class='btn btn-default btn-xs'>PENGAJUAN</a>&nbsp;
                            <a data-toggle="modal" data-target="#exampleModalCenter" class='btn btn-default btn-xs'>REVISI</a>&nbsp;
                            <a href="proses_status_laporan_ta.php?upload_id=<?php echo $id; ?>&tahun=<?php echo $ta; ?>&status=2" class='btn btn-success btn-xs'>ACC</a><br/>
                        <?php } ?>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
