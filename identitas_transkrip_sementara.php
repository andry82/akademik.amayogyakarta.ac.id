<table border="0" style="font-size: 12px;" cellpadding="0" cellspacing="0" width="100%" class="alamat"> 
    <tbody>
        ...
        <tr valign="top" style="font-weight: bold"><td width="18%">Tempat / Tanggal Lahir</td><td width="1%">:</td><td width="30%"><? print($tptlhr_mahasiswa); ?>, <? print(tanggal_indo($tgllhr_mahasiswa)); ?></td><td width="20%">Tanggal Lulus</td><td width="1%">:</td><td width="15%"><?php echo tanggal_indo($transkrip3["tgl_lulus"]); ?></td></tr>
    </tbody>
</table>